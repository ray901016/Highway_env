...
# Load data
npz_path = r"C:\Users\EE715\Documents\Highway_env_miderm\train.npz"
...
# Train model
model.fit(train_data, train_labels, epochs=200, batch_size=64, validation_split=0.1, verbose=2)
